...
[![Dependabot status](https://img.shields.io/endpoint?url=https://api.dependabot.com/badges/status?host=github&repo=careyjames/DNS-Scout)](https://api.dependabot.com/status?host=github&repo=careyjames/DNS-Scout)
